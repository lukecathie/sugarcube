class UIImage
  class << self
    ...
    SugarCube768h_TallSuffix = '-Landscape@2x'  # 1024 x 768 (iPad Landscape)
    SugarCube1024_TallSuffix = '-Portrait@2x'  # 768 x 1024 (iPad Portrait)
    ...
    def sugarcube568_imageNamed(name)
      ...
      when 768
        taller_image_ext = SugarCube768h_TallSuffix
      when 1024
